...
{
    [Obsolete("use the new object spawner that is compatible with the new material randomize handeler")]
    ...
    public class ObjectRandomizeHandler : RandomizerInterface
    {
        ...
        public void Start()
        {
            ...
            materialRandomizeHandler = gameObject.AddComponent<MatRandomizeHandler>();
            if (objectData.seperateSubmodels)
